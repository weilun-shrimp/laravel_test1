...
<div class='row'>
	<div class='col'>
		<h1>修改文章頁面</h1>
		{{ Form::open(array('url' => route('posts.update', $post[0]->id) , 'method' => 'POST')) }}
			<div class="form-group">
			    <?php
			    	...
			    	echo Form::text('title', $post[0]->title , array(
			    		'class' => 'form-control', 
	    	...
	    	<div class="form-group">
		    	<?php
			    	...
			    	echo Form::textarea('content', $post[0]->content , array(
			    		'class' => 'form-control', 
	    	...
	    	<div class="form-group">
		    	<?php
			    	...
			    	echo Form::textarea('excerpt', $post[0]->excerpt , array(
			    		'class' => 'form-control', 
	    	...
	    	<div class="form-group form-check">
		    	<?php
		    		$status = ($post[0]->comment_status=='allow')?'true':'false';
